...
[![CI](https://github.com/zlatanov/modern-pdf/actions/workflows/ci.yml/badge.svg)](https://github.com/zlatanov/modern-pdf/actions/workflows/ci.yml)
...
- `CI` runs build + test and publishes code coverage artifacts/summary on pushes, pull requests, and manual runs.
